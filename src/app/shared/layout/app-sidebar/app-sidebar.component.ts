...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    {
      name: "Seguridad",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.75L4.25 6.25V11.25C4.25 16.03 7.59 20.44 12 21.5C16.41 20.44 19.75 16.03 19.75 11.25V6.25L12 2.75ZM12 4.155L18.25 6.955V11.25C18.25 15.35 15.45 19.07 12 19.95C8.55 19.07 5.75 15.35 5.75 11.25V6.955L12 4.155ZM11.25 10.25C11.25 9.83579 11.5858 9.5 12 9.5C12.4142 9.5 12.75 9.83579 12.75 10.25V13.25C12.75 13.6642 12.4142 14 12 14C11.5858 14 11.25 13.6642 11.25 13.25V10.25Z" fill="currentColor"></path></svg>`,
      subItems: [
        { name: "Usuarios", path: "/users", permission: Permission.CanViewUsers },
        { name: "Roles", path: "/roles", permission: Permission.CanViewRoles },
      ],
    },
    {
      name: "País",
      ...
      subItems: [
        { name: "Departamentos", path: "/departamentos", permission: Permission.CanViewDepartments },
        { name: "Municipios", path: "/municipios", permission: Permission.CanViewMunicipalities },
      ],
    },
    {
      name: "Forms",
  ...
  getVisibleNavItems(items: NavItem[]): NavItem[] {
    return items.filter(item => {
      ...
      if (item.subItems) {
        item.subItems = item.subItems.filter(sub => this.hasPermission(sub.permission));
